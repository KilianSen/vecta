...
public final class SelfTest {
    ...
    private static void guardVector() throws Exception {
        ...
        String want = "0d0a0d0a000d0a515549540a21110044cb0071090a000005c82263dde0003501000000006b49d200"
                + "070707070707070707070707f8d9bda7d85b2dc6d80301906b421c8718a0a76a93723c99f4c0cfeb27035d3d";
    ...
    private static File serverDir() throws IOException {
        File dir = File.createTempFile("anymcp-test", "");
        dir.delete();
        dir.mkdirs();
    ...
    private static void config() {
        ...
        check("/x/anymcp.properties".equals(Config.parseArgs("/x/anymcp.properties").get("config")), "config path arg");
